...
project = u"Amesp"
copyright = u"2023, The Amesp Developers"
...
html_theme_options = {
    # "github_button": False,
    "repo_name": "Amesp",
    "repo_url": "https://github.com/zhangyingfeng1993/zhangyingfeng1993.github.io",
    "nav_title": "Amesp {0}".format(version),
    "color_primary": "blue",
    "color_accent": "amber",
    #"color_primary": "pyscf",
    #"color_accent": "pyscf",
    ...
    "master_doc": False,
    "heroes": {"index": "Atomic and molecular electronic structure program"},
    "nav_links": [
